      ...
      <div className="flex">
        <div className="items-center justify-around flex">
          <div>
            ...
            <div className="pt-6 pb-14 pr-14 pl-14" ><h2 style={{ maxWidth: 524, fontSize: 21.4 }}  className="font-medium font-noto" >Track the traffic on your shorted url's easy, fast and customizable.</h2></div>
